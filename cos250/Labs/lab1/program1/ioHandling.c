...
int decimalInputGetter(){
    ...
    printf("\nPlease enter a 32 bit signed integer.\n\n");
...
int binaryInputGetter(){
    ...
    printf("\nPlease enter a binary number that follows the Two's Complement in groups of 4 digits.\n\n");
...
int hexInputGetter(){
    ...
    printf("\nPlease enter a hexadecimal number formatted as 8 digits without the '0x' prefix, that follows the 2's Complement convention\n");
